    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", marginRight: "auto" }}>
          <Image
            src="/professional-services-v1/logos/revenue-institute.png"
...
function LogoBar() {
  ...
  const logos = [
    { src: "/professional-services-v1/logos/berry-law.png", alt: "Berry Law", w: 126, h: 30, opacity: 0.58 },
    { src: "/professional-services-v1/logos/manely-firm.png", alt: "The Manely Firm", w: 30, h: 30, opacity: 0.75, radius: 6 },
    { src: "/professional-services-v1/logos/inline-logo.svg", alt: "", w: 86, h: 30, opacity: 0.58 },
    { src: "/professional-services-v1/logos/lawtrades.svg", alt: "Lawtrades", w: 54, h: 19, opacity: 0.58 },
    { src: "/professional-services-v1/logos/qualigence.png", alt: "Qualigence", w: 30, h: 30, opacity: 0.75, radius: 6 },
    { src: "/professional-services-v1/logos/production-theory.png", alt: "Production Theory", w: 89, h: 22, opacity: 0.58 },
    { src: "/professional-services-v1/logos/edward-jones.png", alt: "Edward Jones", w: 30, h: 30, opacity: 0.75, radius: 6 },
    { src: "/professional-services-v1/logos/cbre.png", alt: "CBRE", w: 30, h: 30, opacity: 0.75, radius: 6 },
  ];
  return (
        ...
        >
          <div style={{ flex: "1 1 440px", minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 26 }}>
              <Image src="/professional-services-v1/logos/berry-law.png" alt="Berry Law" width={109} height={26} style={{ opacity: 0.75 }} />
